...
class Conta:
    ...
    def transferir(self, valor, conta_destino):
        if self.sacar(valor):
            ...
            print(f"\n=== Transferência de R$ {valor:.2f} realizada com sucesso para a conta {conta_destino.numero}! ===")
        else:
            print("\n@@@ Operação de transferência falhou! Verifique o saldo. @@@")
...
def transferir(clientes, contas):
    ...
    conta_destino_numero = input("Informe o número da conta de destino: ")
    
    conta_destino = next((c for c in contas if c.numero == conta_destino_numero), None)
